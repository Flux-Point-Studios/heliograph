...
|---|---|---|---|---|---|---|---|---|---|---|
| F-PP1 | **pinned** (commit copy before first run) | preprod (magic 1) | `preprod-cert-489d…117e.json` | `e181255a5721a0d5e7005109aabefe47000f838492d36b746b52e2c3e2a116b0` | 5,155 | `489d8770…10c90728`† | 290 / MithrilStakeDistribution | 5 / 100 / 0.7 | 1 / 37 / 24 | Sextant golden vector, Sextant @ `3a68b2f` |
| F-MN1 | **RESERVED — harvest per §3.2 before any run** | mainnet (magic 764824073) | `mainnet-cert-<hash>.json` | — | — | — | — / prefer CardanoTransactions | 1944 / 16948 / 0.2 (verify at harvest) | ~59 / ~2.4k / 244 (verify at harvest) | release-mainnet aggregator, read-only |
...
|---|---|---|---|---|
| _none yet — first scheduled: S-0001, RISC Zero blst `v0.3.16-risczero.0` × mithril-stm 0.10.5 compile spike (§6.2)_ | | | | |
